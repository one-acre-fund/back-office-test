describe("Create Quality of Life (QOL) Expense", function () {
    ...
    it('Should be able to create QOL Expense', function () {
        ...
        browser.waitForAngular();
        browser.driver.findElement(By.xpath("//a[contains(text(),'Create New Monthly Work Expense Reimbursement')]")).click();
        browser.waitForAngular();
        ...
        browser.waitForAngular();
        element(by.name("Description")).sendKeys("Automated description message for Monthly Work Expense Reimbursement");
        browser.waitForAngular();
        element(by.css(".k-numerictextbox")).click();
        browser.waitForAngular();
        element(by.id("UnitPrice")).sendKeys('9500');
        browser.waitForAngular();
