describe("Review Quality of Life (QOL) Expense", function () {
    // Review Quality of Life (QOL) Expense
    it('Should be able to review QOL Expense', function () {
        ...
        browser.waitForAngular();
        element(by.name("Description")).sendKeys("Automated description message");
        browser.waitForAngular();
